...
namespace BitcoinStatisticsPro.Models
{
    ...
    public class CurrencyConverter
    {
        ...
        public CurrencyConverter(string currencyOld, string currencyToResponse)
        {
            this.currencyToResponse = currencyToResponse;
            string urlCurrencyAux = "http://devel.farebookings.com/api/curconversor/" + currencyOld + "/" + currencyToResponse + "/1/json";
